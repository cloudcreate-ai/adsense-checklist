...
const en: Record<string, string> = {
  ...
  'report.approval_mechanical': 'Mechanical estimate',
  'report.approval_expert': 'Expert assessment',
  'report.approval_fast': 'Fast assessment',
  ...
  'md.approval_mechanical_title': 'Mechanical Estimate',
  'md.approval_expert_title': 'Expert Assessment',
  'md.approval_fast_title': 'Fast Assessment',
...
const zh: Record<string, string> = {
  ...
  'report.approval_mechanical': '机械推算',
  'report.approval_expert': '深度评估',
  'report.approval_fast': '快速评估',
  'report.approval_prob': '~{prob}%',
  ...
  'md.approval_mechanical_title': '机械推算',
  'md.approval_expert_title': '深度评估',
  'md.approval_fast_title': '快速评估',
